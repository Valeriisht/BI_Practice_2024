...
<img align=right src="https://github.com/user-attachments/assets/78213191-5934-4b27-8612-4f801cffcb37" alt="# Codon-optimization Tool" width="200"/>
...
Результаты: доступны под названием Wolf

- Для предсказания субклеточной локализации белка воспользуемся утилитой TargetP Server
...
Нам не интересны белки, для которых правдаподобии выше 0.8, так как это означает, что белок скорее всего экспортируется из клетки и не работает в ядре.
